class S2sEvent {
    ...
    static DEFAULT_SYSTEM_PROMPT = "You are a friendly assistant. The user and you will engage in a spoken dialog exchanging the transcripts of a natural real-time conversation. Keep your responses short, generally two or three sentences for chatty scenarios.";
    ...
    static DEFAULT_TOOL_CONFIG = {
      ...
      },
      {
        toolSpec: {
          ...
          description: "Manage bookings and reservations: create, get, update, delete, list, or find bookings by customer name.",
          inputSchema: {
            json: JSON.stringify({
                "type": "object",
                "properties": {
    ...
    static textInput(promptName, contentName, content) {
        return {
            event: {
                textInput: {
                    promptName: promptName,
